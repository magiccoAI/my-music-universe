...
// 删除了进度条的加载组件 
const LoadingScreen = () => ( 
  <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-800 z-50 transition-opacity duration-1000 opacity-100"> 
