...
const AboutPage = () => {
  ...
  const content = {
    zh: {
      ...
      techP2: (
        <>
          未来它或许会迁移发展成更多与我生命相关的东西，但在此刻，它只想温柔地提醒我：这些歌，曾经陪伴我，也仍在陪伴我。这是我作为一位非专业开发者的持续实践，也是一段与工具共创的旅程；每一次迭代，都是在把<span className="text-white font-bold border-b border-sky-500/50">“听过什么歌”</span>变成<span className="text-sky-300 font-bold border-b border-sky-500/50">“看见我的故事”</span>。
        </>
      ),
      techP3: (
        <>
